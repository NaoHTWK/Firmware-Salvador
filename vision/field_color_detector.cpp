 ...
 */
void FieldColorDetector::proceed(Image* img) {
 ...
 */
void FieldColorDetector::extractFeatures(Image* img, float* features){
	int cnt=0;
	float meanY=0;
	float varY=0;
	float varCb=0;
 ...
 */
void FieldColorDetector::searchInitialSeed(Image* img){
