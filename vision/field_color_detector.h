...
public:
    ...
    void proceed(Image* img) __attribute__((nonnull));
    void searchInitialSeed(Image* img);
	void setYCbCrCube(float* features);
    void extractFeatures(Image* img, float* features);
    ...
    inline bool isGreen(Image* img, int x, int y) const {
